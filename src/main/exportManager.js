...
const { allQuery } = require(path.join(__dirname, '..', 'db', 'db'));
const { getSetting } = require(path.join(__dirname, 'settingsManager'));
const {
  ...
  handleGetDonations,
  handleGetExpenses,
} = require(path.join(__dirname, 'financialHandlers'));
