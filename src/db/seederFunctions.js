...
const surahs = [
  ...
  { id: 3, name_ar: 'آل عمران', name_en: 'Aal-E-Imran', revelation_type: 'Medinan', verse_count: 200 },
  ...
  { id: 21, name_ar: 'الأنبياء', name_en: 'Al-Anbiya', revelation_type: 'Meccan', verse_count: 112 },
  { id: 22, name_ar: 'الحج', name_en: 'Al-Hajj', revelation_type: 'Medinan', verse_count: 78 },
  { id: 23, name_ar: 'المؤمنون', name_en: 'Al-Muminun', revelation_type: 'Meccan', verse_count: 118 },
  ...
  { id: 26, name_ar: 'الشعراء', name_en: 'Ash-Shuara', revelation_type: 'Meccan', verse_count: 227 },
  ...
  { id: 29, name_ar: 'العنكبوت', name_en: 'Al-Ankabut', revelation_type: 'Meccan', verse_count: 69 },
  ...
  { id: 45, name_ar: 'الجاثية', name_en: 'Al-Jathiyah', revelation_type: 'Meccan', verse_count: 37 },
  ...
  { id: 49, name_ar: 'الحجرات', name_en: 'Al-Hujurat', revelation_type: 'Medinan', verse_count: 18 },
  { id: 50, name_ar: 'ق', name_en: 'Qaf', revelation_type: 'Meccan', verse_count: 45 },
  { id: 51, name_ar: 'الذاريات', name_en: 'Adh-Dhariyat', revelation_type: 'Meccan', verse_count: 60 },
  ...
  { id: 58, name_ar: 'المجادلة', name_en: 'Al-Mujadila', revelation_type: 'Medinan', verse_count: 22 },
  { id: 59, name_ar: 'الحشر', name_en: 'Al-Hashr', revelation_type: 'Medinan', verse_count: 24 },
  { id: 60, name_ar: 'الممتحنة', name_en: 'Al-Mumtahanah', revelation_type: 'Medinan', verse_count: 13 },
  ...
  { id: 63, name_ar: 'المنافقون', name_en: 'Al-Munafiqun', revelation_type: 'Medinan', verse_count: 11 },
  { id: 64, name_ar: 'التغابن', name_en: 'At-Taghabun', revelation_type: 'Medinan', verse_count: 18 },
  ...
  { id: 73, name_ar: 'المزمل', name_en: 'Al-Muzzammil', revelation_type: 'Meccan', verse_count: 20 },
  { id: 74, name_ar: 'المدثر', name_en: 'Al-Muddaththir', revelation_type: 'Meccan', verse_count: 56 },
  ...
  { id: 77, name_ar: 'المرسلات', name_en: 'Al-Mursalat', revelation_type: 'Meccan', verse_count: 50 },
  ...
  { id: 82, name_ar: 'الإنفطار', name_en: 'Al-Infitar', revelation_type: 'Meccan', verse_count: 19 },
  { id: 83, name_ar: 'المطففين', name_en: 'Al-Mutaffifin', revelation_type: 'Meccan', verse_count: 36 },
  { id: 84, name_ar: 'الإنشقاق', name_en: 'Al-Inshiqaq', revelation_type: 'Meccan', verse_count: 25 },
  ...
  { id: 88, name_ar: 'الغاشية', name_en: 'Al-Ghashiyah', revelation_type: 'Meccan', verse_count: 26 },
  ...
  { id: 99, name_ar: 'الزلزلة', name_en: 'Az-Zalzalah', revelation_type: 'Medinan', verse_count: 8 },
  { id: 100, name_ar: 'العاديات', name_en: 'Al-Adiyat', revelation_type: 'Meccan', verse_count: 11 },
  { id: 101, name_ar: 'القارعة', name_en: 'Al-Qariah', revelation_type: 'Meccan', verse_count: 11 },
  { id: 102, name_ar: 'التكاثر', name_en: 'At-Takathur', revelation_type: 'Meccan', verse_count: 8 },
  ...
  { id: 109, name_ar: 'الكافرون', name_en: 'Al-Kafirun', revelation_type: 'Meccan', verse_count: 6 },
...
async function seedSurahs() {
  ...
  try {
    ...
    for (const surah of surahs) {
      ...
      await runQuery(sql, [surah.id, surah.name_ar, surah.name_en, surah.revelation_type, surah.verse_count]);
    }
