                    ...
                    <Card className="border-0">
                      <Card.Body>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <InputGroup>
                                <Button variant="outline-secondary" onClick={() => handleDirectorySelect('backup_path')} disabled={!settings.backup_enabled}>
                                اختر مجلد...
                                </Button>
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                            <Button variant="info" onClick={handleRunBackup} disabled={isBackingUp || !settings.backup_path}>
                                {isBackingUp ? (
                                    <>
                             ...
                             {backupStatus && (
                                <small className={backupStatus.success ? 'text-success' : 'text-danger'}>
                                    آخر نسخة احتياطية: {new Date(backupStatus.timestamp).toLocaleString()} - {backupStatus.success ? 'نجحت' : 'فشلت'}
                                </small>
                            )}
                        </div>
                      </Card.Body>
