  ...
  return (
    <Row>
      <Col md={6} className="mb-4">
        <Card>
          <Card.Header as="h5">
            <UserTieIcon className="me-2" />تواصل مع المطور
          </Card.Header>
          <Card.Body>
            <Card.Title>{developerInfo.name}</Card.Title>
            <p><EnvelopeIcon className="me-2" /><a href={`mailto:${developerInfo.email}`}>{developerInfo.email}</a></p>
            <p><WhatsappIcon className="me-2" /><a href={`https://wa.me/${developerInfo.whatsapp.replace('+', '')}`} target="_blank" rel="noopener noreferrer">{developerInfo.whatsapp}</a></p>
            <p><GithubIcon className="me-2" /><a href={developerInfo.github} target="_blank" rel="noopener noreferrer">GitHub</a></p>
            <p><LinkedinIcon className="me-2" /><a href={developerInfo.linkedin} target="_blank" rel="noopener noreferrer">LinkedIn</a></p>
          </Card.Body>
        </Card>
      </Col>
      <Col md={6} className="mb-4">
        <Card>
          <Card.Header as="h5">
            <BugIcon className="me-2" />الإبلاغ عن خطأ
          </Card.Header>
          <Card.Body>
      ...
      <Col md={12} className="mb-4">
        <Card>
          <Card.Header as="h5">
            <HeartIcon className="me-2" />شكر وتقدير
          </Card.Header>
          <Card.Body>
